								...
								<table class="responsive table table-striped table-bordered"
									...
									<tr>
										<td>第一节课（上午）</td>
										 ...
										 <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==1&&bean.num==1 }">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 		  </span> 
										 		-<span class='table_room'> ${bean.room }</span>
										 		<span class='table_username'>(人数：${bean.usernum })</span>
										 		 <br>
										 		 </c:if>
										 	</c:forEach>
										</td>
										 ...
										 <td>
										 <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==2&&bean.num==1 }">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
											 <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==3&&bean.num==1 }">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==4&&bean.num==1 }">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==5&&bean.num==1 }">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
									...
									<tr>
										<td>第二节课（上午）</td>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==1&&bean.num==2}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==2&&bean.num==2}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==3&&bean.num==2}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==4&&bean.num==2}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==5&&bean.num==2}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
									...
									<tr>
										<td>第三节课（上午）</td>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==1&&bean.num==3}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==2&&bean.num==3}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==3&&bean.num==3}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==4&&bean.num==3}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==5&&bean.num==3}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
									...
									<tr>
										<td>第四节课（下午）</td>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==1&&bean.num==4}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==2&&bean.num==4}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==3&&bean.num==4}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==4&&bean.num==4}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==5&&bean.num==4}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
									...
									<tr>
										<td>第五节课（下午）</td>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==1&&bean.num==5}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==2&&bean.num==5}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==3&&bean.num==5}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==4&&bean.num==5}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==5&&bean.num==5}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
									...
									<tr>
										<td>第六节课（下午）</td>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==1&&bean.num==6}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==2&&bean.num==6}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==3&&bean.num==6}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										  <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==4&&bean.num==6}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
										 ...
										 <td>
										   <c:forEach var="bean" items="${list }">
										 		<c:if test="${bean.week==5&&bean.num==6}">
										 		 <span class='table_category'>
										 		 <a href="${pageContext.request.contextPath}/admin/timetable/doselect?id=${bean.id}">
										 		  ${bean.category.name}
										 		 </a>
