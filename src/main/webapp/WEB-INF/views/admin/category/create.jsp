				...
				<div class="row-fluid ">
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<form action="${pageContext.request.contextPath}/admin/category/create" method="post" id=''>
							...
							<div class="control-group">
								<label for="title" class="control-label">简介：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">课程描述：</label>
								<div class="controls">
									<textarea  id='context' name='remark1' style="width: 100%;height: 600px"></textarea>
								</div>
							</div>
