          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="envor-desktop-breadscrubs-inner">
                <a href="index.html">首页</a><i class="fa fa-angle-double-right"></i>用户报名
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row" style="margin-bottom: 30px">
           <div class="col-lg-6 col-md-6">
              ...
              <div class="riva-toggle-tab" style="display: block;">
                <h2><strong>报名</strong> </h2>
                <form class="envor-f1" action="doreport" method="post">
                  <p><label for="rt1-first-name">班级</label>
                    ...
                    <p><label for="rt1-phone">付款方式</label>
                    <select name='pay'>
                    <option value=""></option>
                  ...
                  <p><label for="rt1-email">电话</label><input type="text"  name='email'></p>
            ...
            //-->
             	...
             	<div class="col-lg-6 col-md-6">
             	<p><strong>支持以下几种付款方式</strong> </p>
             			 <div class="row" >
             			 <div  class="col-lg-4 col-md-4" ><span><img src="https://beecloud.cn/image/new_index/icon_wx.png"></span></div>
             			  <div  class="col-lg-4 col-md-4" ><span><img src="https://beecloud.cn/image/new_index/icon_ali.png"></span></div>
             			 <div  class="col-lg-4 col-md-4" ><span><img src="https://beecloud.cn/image/new_index/icon_yb.png"></span></div>
             			 </div>
             			  <div class="row" >
             			 <div  class="col-lg-4 col-md-4" ><span><img src="https://beecloud.cn/image/new_index/icon_yl.png"></span></div>
             			  <div  class="col-lg-4 col-md-4" ><span><img src="https://beecloud.cn/image/new_index/icon_bd.png"></span></div>
             			 <div  class="col-lg-4 col-md-4" ><span><img src="https://beecloud.cn/image/new_index/icon_paypal.png"></span></div>
             			 </div>
             	</div>
			</div>
