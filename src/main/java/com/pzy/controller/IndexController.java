...
public class IndexController {
	...
	public String gologin(HttpSession httpSession,String userName,String password,Model model,String role)  {
    	...
    	if("admin".equals(userName)&&"123456".equals(password)&&"管理员".equals(role)){
    		User admin=new User();  
